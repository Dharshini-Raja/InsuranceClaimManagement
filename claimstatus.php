...
<?php
	...
	while($row = $result->fetch_assoc()) {
		...
		echo "   <td><a href =fileupclient.php?client_id1=". urlencode($row["client_id"]) ."\">".$row["death_certificate"]."</td>\n";
	    ...
	    echo "<br>\n";
		echo "<b> Note: Status  '-'   indicates the claim is under processing,kindly check back later</b>";
		?>